		    ...
		    <div class="display-content">
		      ...
		      <div class="message">
		        <div class="message-image">
							<img src="~/assets/photo_2020-08-01_17-38-46.jpg" alt="">
		        </div>
...
.phone {
  ...
  left: calc(50% - 8px);
  top: calc(50% - 2px);
  transform: translate(-50%, -50%) rotate(-10deg) skewX(24deg);
}

@media screen and (max-width: 1400px) {
  .phone {
    transform: translate(-50%, -50%) rotate(-10deg) skewX(28deg) scale(0.7);
  }
}
...
.change-plan {
  ...
  font-weight: 400;
  font-size: 14px;
  background-image: -webkit-gradient(linear, left top, right top, from(#1a7eff), to(#44b9ff));
...
.plan-list {
  ...
  .plan-limit {
    ...
    .limit-icon {
      ...
      &.upgrade {
        border: none;
        background-image: -webkit-gradient(linear, left top, left bottom, from(#50d2f4), to(#3660f2));
